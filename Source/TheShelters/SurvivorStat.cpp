...
void USurvivorStat::InitSurvivorStat(int _food, int _water, int _elec, int _hunger, int _thirst, int _mental,
                                     int _progress)
{
    this->food = _food;
    this->water = _water;
...
void USurvivorStat::Consume()
{
    ...
    Hunger(-hungerPerTime);
    Thirst(-hungerPerTime * thirstMultiplier);
}
